...
async function updateVideoUrls() {
  ...
  if (popeLatest) {
    ...
    await db.execute(
      sql.raw(`UPDATE jobs SET video_url = '${videoUrl}' WHERE id = '13f8da7f-be93-4b2f-8ca4-a3da8d2a02ce'`),
    );
  ...
  if (tomoeLatest) {
    ...
    await db.execute(
      sql.raw(`UPDATE jobs SET video_url = '${videoUrl}' WHERE id = '1efa0a2b-778d-405d-a54d-82abfd96d8d3'`),
    );
